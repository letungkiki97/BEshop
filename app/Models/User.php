    ...
    JWTSubject
{
    use Authenticatable, Authorizable, CanResetPassword,
	    Billable, Notifiable, HistoryTrait;
    ...
    {
        return $this->hasMany(Saleorder::class, 'sales_person_id');
    }

    public function purchase()
    {
        return $this->hasMany(Purchase::class, 'assigned_to');
    }
    ...
    {
        return $this->belongsTo(Storage::class, 'to_storage');
    }
