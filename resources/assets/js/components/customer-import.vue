    ...
    <div>
        <form class="form-horizontal" @submit.prevent="uploadFile">
            <div class="fileinput fileinput-new" data-provides="fileinput">
                ...
                <a href="#" class="close fileinput-exists" data-dismiss="fileinput" style="float: none" ref="temp">&times;</a>
            </div>
            <br>
        ...
        <table class="table sales-team import-wrapper" v-if="total">
            ...
            <tbody>
                <tr v-for="item in data" :class="{'alert-info':item.created}">
                    ...
                    <td>
                        <!-- {{ item.title }} -->
                        <select class="form-control" name="title" :options="titles" data-placeholder="Select Title" style="width: 100%" v-model="item.title">
                    ...
                    <td>
                        <select class="form-control" name="company_id" :options="companies" data-placeholder="Select Company" style="width: 100%" v-model="item.company_id">
                            <option value="" disabled="disabled">default</option>
