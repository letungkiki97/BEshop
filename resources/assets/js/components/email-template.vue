            ...
            <div class="col-sm-4 col-md-3">
                <div id="cnt-list">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control no-border no-bg" placeholder="Search email templates" v-model="query">
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="list" v-for="template in templatefilter" :key="template.id" :class="{'active': template.selected }" style="cursor: pointer">
                            ...
                            <div v-if="item">
                                <div style="margin: 10px 0">
                                    <div>
                                        ...
                                        <a class="btn btn-sm btn-primary" v-show="!this.item.editing" @click="editItem(item)" v-if="can_write">Edit</a>
