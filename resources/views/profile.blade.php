        ...
        <div class="col-sm-7 col-md-9 col-sm-offset-1">
            <div class="table-responsive">
                <table class="table table-bordered">
                    <tbody>
                    <tr>
                        <td><b>{{trans('user.first_name')}}</b></td>
                        <td><a href="#"> {{$user_data->first_name}}</a></td>
                    </tr>
                    <tr>
                        <td><b>{{trans('user.last_name')}}</b></td>
                        <td><a href="#"> {{$user_data->last_name}}</a></td>
                    </tr>
                    <tr>
                        <td><b>{{trans('user.email')}}</b></td>
                        <td><a href="#">{{$user_data->email}}</a></td>
                    </tr>
                    <tr>
                        <td><b>{{trans('user.phone_number')}}</b></td>
                        <td><a href="#"> {{$user_data->phone_number}}</a></td>
                    </tr>
                    </tbody>
                </table>
                <a href="{{url('account')}}" class="btn btn-success">
                    <i class="fa fa-pencil-square-o"></i> {{trans('user.change_profile')}}</a>
            </div>
        </div>
    </div>
