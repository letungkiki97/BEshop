                ...
                <ul class="nav nav-tabs" style="display:list-item;">
                    <li class="active">
                        <a href="#general_configuration"
                           data-toggle="tab" title="{{ __('tab.general') }}"><i
                                    class="material-icons md-24">build</i></a>
                    </li>
                    <li>
                        <a href="#email_configuration"
                           data-toggle="tab" title="{{ __('tab.email') }}"><i
                                    class="material-icons md-24">email</i></a>
                    </li>
                    <li>
                        <a href="#supplier_configuration"
                           data-toggle="tab" title="{{ __('tab.supplier') }}"><i
                                    class="material-icons md-24">store</i></a>
                    </li>
                    <li>
                        <a href="#sales_configuration"
                           data-toggle="tab" title="{{ __('tab.sales') }}"><i
                                    class="material-icons md-24">shopping_cart</i></a>
                    </li>
                    <li>
                        <a href="#requirement_configuration"
                           data-toggle="tab" title="{{ __('tab.requirement') }}"><i
                                    class="material-icons md-24">perm_data_setting</i></a>
                    </li>
                    <li>
                        <a href="#delivery_configuration"
                    ...
                    <li>
                        <a href="#other_configuration"
                           data-toggle="tab" title="{{ __('tab.other') }}"><i
                                    class="material-icons md-24">settings</i></a>
                    </li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane active" id="general_configuration">
                        ...
                        <div class="form-group required {{ $errors->has('hotline') ? 'has-error' : '' }}">
                            ...
                            <div class="controls">
                                {!! Form::text('hotline', old('hotline', Settings::get('hotline')), array('class' => 'form-control')) !!}
                        ...
                        <div class="form-group required {{ $errors->has('date_format') ? 'has-error' : '' }}">
                            ...
                            <div class="controls">
                                ...
                                <div class="form-inline" style="display: none;">
                                    {!! Form::radio('date_format', 'm/d/Y',false,array('class' => 'icheck', 'id'=>'date_format_custom_radio'))  !!}
                    ...
                    <div class="tab-pane" id="email_configuration">
                        {{-- <div class="form-group required {{ $errors->has('email_driver') ? 'has-error' : '' }}">
                            ...
                            <div class="controls">
                                <div class="form-inline">
                                    <div class="radio">
                                        {!! Form::radio('email_driver', 'mail',(Settings::get('email_driver')=='mail')?true:false,array('id'=>'mail','class' => 'email_driver icheck'))  !!}
                                        {!! Form::label('true', 'MAIL')  !!}
                                    </div>
                                    <div class="radio">
                                        {!! Form::radio('email_driver', 'smtp', (Settings::get('email_driver')=='smtp')?true:false,array('id'=>'smtp','class' => 'email_driver icheck'))  !!}
                        ...
                        <div class="form-group required {{ $errors->has('email_driver') ? 'has-error' : '' }}">
                            {!! Form::label('email_driver', __('setting.email_driver'), array('class' => 'control-label')) !!}
                            <div class="controls">
                                {!! Form::input('text','email_driver', old('email_driver', Settings::get('email_driver')), array('class' => 'form-control')) !!}
                                <span class="help-block">{{ $errors->first('email_driver', ':message') }}</span>
                            </div>
                        </div>
                        ...
                        <div class="form-group required {{ $errors->has('email_username') ? 'has-error' : '' }}">
                            {!! Form::label('email_username', __('setting.email_username'), array('class' => 'control-label')) !!}
                            <div class="controls">
                        ...
                        <div class="form-group required {{ $errors->has('email_password') ? 'has-error' : '' }}">
                            {!! Form::label('email_password', __('setting.email_password'), array('class' => 'control-label')) !!}
                            <div class="controls">
                            ...
                            <div class="controls">
                                <table class="table table-bordered">
                                    ...
                                    <tbody id="mail_list">
                                        ...
                                        <tr>
                                            <td>
                                                {!! Form::input('text','mail_account[]', old('mail_account[]', $a), array('class' => 'form-control')) !!}
                                            </td>
                                            <td>
                                                {!! Form::input('text','mail_password[]', old('mail_password[]', $p), array('class' => 'form-control')) !!}
                                            </td>
                                            <td>
                    ...
                    <div class="tab-pane" id="supplier_configuration">
                        <div class="form-group required {{ $errors->has('international_transport_rate_volume') ? 'has-error' : '' }}">
                            {!! Form::label('international_transport_rate_volume', __('setting.international_transport_rate_volume'), array('class' => 'control-label')) !!}
                            <div class="controls">
                                {!! Form::text('international_transport_rate_volume', old('international_transport_rate_volume', Settings::get('international_transport_rate_volume')), array('class' => 'form-control number')) !!}
                        ...
                        <div class="form-group required {{ $errors->has('international_transport_rate_kg') ? 'has-error' : '' }}">
                            {!! Form::label('international_transport_rate_kg', __('setting.international_transport_rate_kg'), array('class' => 'control-label')) !!}
                            <div class="controls">
                                {!! Form::text('international_transport_rate_kg', old('international_transport_rate_kg', Settings::get('international_transport_rate_kg')), array('class' => 'form-control number')) !!}
                        ...
                        <div class="form-group required {{ $errors->has('ordering_fee') ? 'has-error' : '' }}">
                            ...
                            <div class="controls">
                                {!! Form::number('ordering_fee', old('ordering_fee', Settings::get('ordering_fee')), array('class' => 'form-control', 'min' => 0.01, 'max' => 100, 'step' => 0.01)) !!}
                        ...
                        <div class="form-group required {{ $errors->has('default_lead_time') ? 'has-error' : '' }}">
                            {!! Form::label('default_lead_time', __('setting.default_lead_time'), array('class' => 'control-label')) !!}
                            <div class="controls">
                                {!! Form::number('default_lead_time', old('default_lead_time', Settings::get('default_lead_time')), array('class' => 'form-control')) !!}
                    ...
                    <div class="tab-pane" id="requirement_configuration">
                        <div class="form-group required {{ $errors->has('mrp_hour') ? 'has-error' : '' }}">
                            ...
                            <div class="controls">
                                {!! Form::number('mrp_hour', old('mrp_hour', Settings::get('mrp_hour')), array('class' => 'form-control')) !!}
                    ...
                    <div class="tab-pane" id="sales_configuration">
                        <div class="form-group {{ $errors->has('sales_person') ? 'has-error' : '' }}">
                            ...
                            <div class="controls">
                                {!! Form::select('sales_person', $staffs, old('sales_person', Settings::get('sales_person')), array('class' => 'form-control select2')) !!}
                        ...
                        <div class="form-group required {{ $errors->has('deposit') ? 'has-error' : '' }}">
                            ...
                            <div class="controls">
                                {!! Form::number('deposit', old('deposit', Settings::get('deposit')), array('class' => 'form-control', 'min' => 0.01, 'max' => 100, 'step' => 0.01)) !!}
                        ...
                        <div class="form-group required {{ $errors->has('tracking_number') ? 'has-error' : '' }}">
                            {!! Form::label('tracking_number', __('setting.tracking_number'), array('class' => 'control-label')) !!}
                            <div class="controls">
                                {!! Form::text('tracking_number', old('tracking_number', Settings::get('tracking_number')), array('class' => 'form-control', 'readonly' => true)) !!}
                    ...
                    <div class="tab-pane" id="delivery_configuration">
                        <div class="form-group required {{ $errors->has('picking_lead_time') ? 'has-error' : '' }}">
                            {!! Form::label('picking_lead_time', __('setting.picking_lead_time'), array('class' => 'control-label')) !!}
                            <div class="controls">
                                {!! Form::number('picking_lead_time', old('picking_lead_time', Settings::get('picking_lead_time')), array('class' => 'form-control')) !!}
                    ...
                    <div class="tab-pane" id="other_configuration">
                        <div class="form-group {{ $errors->has('endpoint_url') ? 'has-error' : '' }}">
                            ...
                            <div class="controls">
                                {!! Form::input('text','endpoint_url', old('endpoint_url', Settings::get('endpoint_url')), array('class' => 'form-control')) !!}
                        ...
                        <div class="form-group {{ $errors->has('consumer_key') ? 'has-error' : '' }}">
                            ...
                            <div class="controls">
                                {!! Form::input('text','consumer_key', old('consumer_key', Settings::get('consumer_key')), array('class' => 'form-control')) !!}
                                <span class="help-block">{{ $errors->first('consumer_key', ':message') }}</span>
                            </div>
                        </div>
                        <div class="form-group {{ $errors->has('consumer_secret') ? 'has-error' : '' }}">
                            {!! Form::label('consumer_secret', __('setting.consumer_secret'), array('class' => 'control-label')) !!}
                            <div class="controls">
                                {!! Form::input('text','consumer_secret', old('consumer_secret', Settings::get('consumer_secret')), array('class' => 'form-control')) !!}
                        ...
                        <div class="form-group {{ $errors->has('gtm_code') ? 'has-error' : '' }}">
                            ...
                            <div class="controls">
                                {!! Form::input('text','gtm_code', old('gtm_code', Settings::get('gtm_code')), array('class' => 'form-control')) !!}
                        ...
                        <div class="form-group {{ $errors->has('ga_code') ? 'has-error' : '' }}">
                            ...
                            <div class="controls">
                                {!! Form::input('text','ga_code', old('ga_code', Settings::get('ga_code')), array('class' => 'form-control')) !!}
